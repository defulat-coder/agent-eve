...
- TypeScript CLI 默认使用 TS7 原生编译器；`typescript` 包名保留为
  `@typescript/typescript6` 兼容 API，供 `typescript-eslint`、Next.js plugin
  等工具使用。在 TS7 JavaScript API 和相关生态完成适配前不要删除兼容层。
